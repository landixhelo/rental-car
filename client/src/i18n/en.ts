...
export const en: Dict = {
  ...
  home: {
    ...
    how2Title: "Contact us",
    how2Text: "Send us your dates and details — online or on WhatsApp.",
    ...
    why5Text: "WhatsApp and phone when you need help.",
    why6Title: "Easy & fast booking",
    why6Text: "Three steps: choose, book, drive.",
    pricingEyebrow: "RATES",
    pricingTitle: "Clear pricing",
    pricingSub: "From the daily rate. Longer rentals cost less per day. Confirm on WhatsApp.",
    ...
    reviewsEmpty: "The first reviews will appear here. Message us on WhatsApp after your trip.",
  ...
  faq: {
    ...
    a4: "Yes. Meet & greet at TIA (Nënë Tereza). Send your flight number on WhatsApp so we can wait for you.",

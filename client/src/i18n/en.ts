...
export const en: Dict = {
  ...
  push: {
    ...
    hint: "When someone books on the site, this phone gets an alert — even if the app is closed.",
    enable: "Enable notifications",
    disable: "Turn off",
    enabled: "Phone notifications are on.",
    denied: "Permission was denied. Open browser settings and allow notifications for this site.",
    unsupported: "This browser does not support push notifications.",
    disabled: "Push notifications are not configured on the server yet.",
    iosInstall: "On iPhone: first add the site to your Home Screen (Share → Add to Home Screen), then open the app and enable notifications.",
    error: "Could not enable. Try again.",
    later: "Not now",
    how: "How to",
  ...
  home: {
    ...
    how1Text: "Select the vehicle that fits your trip.",
    how2Title: "Book online",
    how2Text: "Set your dates, pickup point and confirm the reservation on the site.",
    how3Title: "Pick up & drive",
    how3Text: "Get your car and enjoy Albania.",
    whyEyebrow: "WHY US",
    why1Title: "Wide selection of vehicles",
    why1Text: "SUVs, sedans and sports cars for every trip.",
    why2Title: "Competitive prices",
    why2Text: "Clear daily rates, no surprises at pickup.",
    why3Title: "Airport delivery",
    why3Text: "Meet & greet at Tirana Airport with your flight number.",
    why4Title: "Delivery anywhere in Albania",
    why4Text: "Tirana, Durrës, Vlorë, Sarandë — with notice.",
    why5Title: "24/7 support",
    why5Text: "Phone and email when you need help.",
    why6Title: "Easy & fast booking",
    why6Text: "Three steps: choose, book, drive.",
    pricingEyebrow: "RATES",
    pricingTitle: "Clear pricing",
    pricingSub: "From the daily rate. Longer rentals cost less per day. Confirm on the site.",
    price1Title: "1–2 days",
    price3Title: "3–6 days",
    price7Title: "7+ days",
    locationsTitle: "Where to pick up",
    reviewsEyebrow: "CUSTOMERS",
    reviewsTitle: "What our customers say",
    reviewsBased: "Based on",
    reviewsFallback: "customer ratings",
    reviewsEmpty: "The first reviews will appear here after trips.",
    faqTitle: "Frequently asked questions",
    faqAll: "See all FAQs",
    ctaWhatsapp: "Book on WhatsApp",
    finalCtaTitle: "Book your car today",
    finalCta: "Book now",
  ...
  chat: {
    ...
    subtitle: "We reply as soon as we can by email or phone.",
    ...
    waPrefill: "Hello Auto Rental, I want to book a car.",
  },
  chats: {
    title: "Chats",
  ...
  faq: {
    ...
    a1: "A valid driving licence and ID or passport. You can upload them during booking. Minimum age is usually 21 (some categories need more experience).",
    q2: "What is the minimum age?",
    a2: "Usually 21 with a valid licence. Luxury or sports cars may require a higher age or more driving experience — we confirm before handover.",
    q3: "Is insurance included?",
    a3: "Yes. Cars are covered per the rental contract (typically TPL plus extras). You remain responsible for the excess and damage outside cover.",
    q4: "Can I pick up the car at Tirana Airport?",
    a4: "Yes. Meet & greet at TIA (Nënë Tereza). Add your flight number in the booking notes so we can wait for you.",
    q5: "Can I return the car in another city?",
    a5: "Yes, with notice: e.g. pick up in Tirana and return in Durrës, Vlorë or at the airport. Any one-way fee is stated before confirmation.",
    q6: "Is there a security deposit?",
    a6: "Yes, depending on the car category. The deposit is a hold and is returned after inspection, minus justified damage.",
    q7: "Can I rent without a credit card?",
    a7: "Yes. We accept cash at pickup and bank transfer. Card is optional when Stripe is enabled.",
    q8: "Do you offer airport delivery?",
    a8: "Yes. Delivery to Tirana Airport and, with notice, to a hotel/address in Tirana, Durrës, Vlorë or Sarandë.",
  },
  terms: {

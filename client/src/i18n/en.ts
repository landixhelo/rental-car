...
export const en: Dict = {
  ...
  marketplace: {
    title: "Marketplace",
    subtitle: "Partner rentals and cars for sale — in one place.",
    tabRent: "Rent (partners)",
    tabBuy: "Buy / Sell",
    ...
    browseFleet: "Browse rental cars",
    orBrowse: "Or browse the full fleet:",
    albania: "Albania",
    cars: "cars",
    back: "Marketplace",
    ...
    sellerHub: "Sales & My shop",
    sellerHubSub: "Publish your rental shop and sale listings.",
    viewMarketplace: "View marketplace",
    myShop: "My shop (rentals)",
    myShopHelp: "When public, buyers see your fleet at /shops/slug.",
    company: "Company name",
    slug: "Slug (e.g. landi-rent)",
    city: "City",
    logoUrl: "Logo URL (optional)",
    bio: "Short bio",
    publishShop: "Make shop public on marketplace",
    shopSaved: "Shop saved",
    sellCar: "List a car for sale",
    sellHelp: "Listings go for approval, then appear under Buy / Sell.",

...
export const it: Dict = {
  ...
  marketplace: {
    title: "Marketplace",
    subtitle: "Noleggi partner e auto in vendita — in un unico posto.",
    tabRent: "Noleggio (partner)",
    tabBuy: "Compra / Vendi",
    ...
    browseFleet: "Vedi auto a noleggio",
    orBrowse: "Oppure sfoglia tutta la flotta:",
    albania: "Albania",
    cars: "auto",
    back: "Marketplace",
    shopMissing: "Negozio non trovato.",
    fleet: "Flotta a noleggio",
    ...
    sellerHub: "Vendite & Il mio negozio",
    sellerHubSub: "Pubblica il negozio noleggio e gli annunci di vendita.",
    viewMarketplace: "Vedi marketplace",
    myShop: "Il mio negozio (noleggio)",
    myShopHelp: "Se pubblico, la flotta appare su /shops/slug.",
    company: "Nome azienda",
    slug: "Slug (es. landi-rent)",
    city: "Città",
    logoUrl: "URL logo (opzionale)",
    bio: "Breve descrizione",
    publishShop: "Rendi il negozio pubblico",
    shopSaved: "Negozio salvato",
    sellCar: "Metti un'auto in vendita",
    sellHelp: "Gli annunci vanno in approvazione, poi compaiono in Compra / Vendi.",

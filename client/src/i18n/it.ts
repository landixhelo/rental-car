...
export const it: Dict = {
  ...
  home: {
    ...
    how2Title: "Contattaci",
    how2Text: "Invia date e dettagli — online o su WhatsApp.",
    ...
    why5Text: "WhatsApp e telefono quando ti serve aiuto.",
    ...
    reviewsEmpty: "Le prime recensioni appariranno qui. Scrivici su WhatsApp dopo il viaggio.",
  ...
  faq: {
    ...
    a4: "Sì. Incontro a TIA (Nënë Tereza). Invia il numero del volo su WhatsApp.",

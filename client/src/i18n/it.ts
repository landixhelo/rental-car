...
export const it: Dict = {
  ...
  push: {
    ...
    hint: "Quando qualcuno prenota sul sito, questo telefono riceve un avviso — anche se l'app è chiusa.",
    enable: "Attiva le notifiche",
    disable: "Disattiva",
    enabled: "Le notifiche sul telefono sono attive.",
    denied: "Permesso rifiutato. Apri le impostazioni del browser e consenti le notifiche per questo sito.",
    unsupported: "Questo browser non supporta le notifiche push.",
    disabled: "Le notifiche push non sono ancora configurate sul server.",
    iosInstall: "Su iPhone: prima aggiungi il sito alla schermata Home (Condividi → Aggiungi alla schermata Home), poi apri l'app e attiva le notifiche.",
    error: "Impossibile attivare. Riprova.",
    later: "Non ora",
    how: "Come fare",
  ...
  home: {
    ...
    how1Text: "Scegli il veicolo adatto al tuo viaggio.",
    how2Title: "Prenota online",
    how2Text: "Inserisci date e ritiro e conferma la prenotazione sul sito.",
    how3Title: "Ritira e parti",
    how3Text: "Prendi l’auto e goditi l’Albania.",
    whyEyebrow: "PERCHÉ NOI",
    why1Title: "Ampia scelta di auto",
    why1Text: "SUV, berline e sportive per ogni viaggio.",
    why2Title: "Prezzi competitivi",
    why2Text: "Tariffe chiare, senza sorprese al ritiro.",
    why3Title: "Consegna in aeroporto",
    why3Text: "Ti aspettiamo a TIA con il numero del volo.",
    why4Title: "Consegna in tutta l’Albania",
    why4Text: "Tirana, Durazzo, Valona, Saranda — su preavviso.",
    why5Title: "Supporto 24/7",
    why5Text: "Telefono ed email quando ti serve aiuto.",
    why6Title: "Prenotazione facile e veloce",
    why6Text: "Tre passi: scegli, prenota, parti.",
    pricingEyebrow: "TARIFFE",
    pricingTitle: "Prezzi chiari",
    pricingSub: "Dal prezzo giornaliero. Noleggi più lunghi costano meno al giorno.",
    price1Title: "1–2 giorni",
    price3Title: "3–6 giorni",
    price7Title: "7+ giorni",
    locationsTitle: "Dove ritirare l’auto",
    reviewsEyebrow: "CLIENTI",
    reviewsTitle: "Cosa dicono i clienti",
    reviewsBased: "Basato su",
    reviewsFallback: "valutazioni dei clienti",
    reviewsEmpty: "Le prime recensioni appariranno qui dopo i viaggi.",
    faqTitle: "Domande frequenti",
    faqAll: "Vedi tutte le FAQ",
    ctaWhatsapp: "Prenota su WhatsApp",
    finalCtaTitle: "Prenota l’auto oggi",
  ...
  chat: {
    ...
    subtitle: "Rispondiamo al più presto via email o telefono.",
    ...
    waPrefill: "Salve Auto Rental, vorrei prenotare un'auto.",
  },
  chats: {
    title: "Chat",
  ...
  faq: {
    title: "FAQ",
    q1: "Quali documenti servono per noleggiare un’auto?",
    a1: "Patente valida e carta d’identità o passaporto. Puoi caricarli in prenotazione. Età minima di solito 21 anni.",
    q2: "Qual è l’età minima?",
    a2: "Di solito 21 anni con patente valida. Auto di lusso o sportive possono richiedere età/esperienza maggiore.",
    q3: "L’assicurazione è inclusa?",
    a3: "Sì. Le auto sono coperte dal contratto (di solito RCA e extra). Restano a carico tuo franchigia e danni fuori copertura.",
    q4: "Posso ritirare l’auto all’aeroporto di Tirana?",
    a4: "Sì. Incontro a TIA (Nënë Tereza). Indica il numero del volo nelle note della prenotazione.",
    q5: "Posso riconsegnare l’auto in un’altra città?",
    a5: "Sì, con preavviso: es. ritiro a Tirana e reso a Durazzo, Valona o in aeroporto. L’eventuale tariffa one-way è comunicata prima.",
    q6: "C’è un deposito cauzionale?",
    a6: "Sì, in base alla categoria. Il deposito viene restituito dopo il controllo, meno i danni giustificati.",
    q7: "Posso noleggiare senza carta di credito?",
    a7: "Sì. Accettiamo contanti al ritiro e bonifico. La carta è opzionale quando Stripe è attivo.",
    q8: "Offrite consegna in aeroporto?",
    a8: "Sì. Consegna all’aeroporto di Tirana e, su preavviso, in hotel/indirizzo a Tirana, Durazzo, Valona o Saranda.",
  },
  terms: {
  ...
  details: {
    ...
    noDailyRentals:
      "Questa flotta non accetta noleggi giornalieri. Il minimo è di {days} giorni.",
    ...
    extras: "Extra",
    payment: "Pagamento",
    cardUnavailable: "Al momento non disponibile",
    notes: "Note",
    document: "Documento",
    total: "Totale",

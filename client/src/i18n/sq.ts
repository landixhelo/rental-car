export const sq = {
  ...
  home: {
    ...
    how2Title: "Na kontakto",
    how2Text: "Dërgo datat dhe detajet — online ose në WhatsApp.",
    ...
    why5Text: "WhatsApp dhe telefon kur të duhet ndihmë.",
    why6Title: "Rezervim i shpejtë",
    why6Text: "Tre hapa: zgjidh, rezervo, nisu.",
    pricingEyebrow: "TARIFAT",
    pricingTitle: "Çmime të qarta",
    pricingSub: "Nga çmimi ditor. Zbritje për qira më të gjata. Konfirmim në WhatsApp.",
    ...
    reviewsEmpty: "Vlerësimet e para do të shfaqen këtu. Na shkruaj në WhatsApp pas udhëtimit.",
  ...
  faq: {
    ...
    a4: "Po. Dërgesë / marrje në TIA (Nënë Tereza). Na dërgo numrin e fluturimit në WhatsApp që të të presim.",

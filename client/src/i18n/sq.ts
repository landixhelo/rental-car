export const sq = {
  ...
  home: {
    ...
    feature3Text: "Autentifikim i fortë, bazë e mbrojtur dhe validim i plotë",
  ...
  marketplace: {
    title: "Marketplace",
    subtitle:
      "Qira nga partnerët dhe makina në shitje — e gjitha në një vend.",
    tabRent: "Qira (partnerë)",
    tabBuy: "Blej / Shit",
    ...
    browseFleet: "Shiko makinat me qira",
    orBrowse: "Ose shiko të gjithë flotën:",
    albania: "Shqipëri",
    cars: "makina",
    back: "Marketplace",
    ...
    sellerHub: "Shitje & Dyqani im",
    sellerHubSub: "Publiko dyqanin e qirasë dhe listimet për shitje.",
    viewMarketplace: "Shiko marketplace",
    myShop: "Dyqani im (qira)",
    myShopHelp:
      "Kur e bën publik, partnerët të shohin flotën tënde te /shops/slug.",
    company: "Emri i kompanisë",
    slug: "Slug (p.sh. landi-rent)",
    city: "Qyteti",
    logoUrl: "URL e logos (opsionale)",
    bio: "Përshkrim i shkurtër",
    publishShop: "Bëje dyqanin publik në marketplace",
    shopSaved: "Dyqani u ruajt",
    sellCar: "Listo makinë për shitje",
    sellHelp: "Listimi shkon për aprovim, pastaj shfaqet te Blej / Shit.",
